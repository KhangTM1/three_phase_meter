...
def check_for_changes(current_data):
    # if last_data_1 and last_data_2:
    #     for key in current_data:
    #         if key in last_data_1 and key in last_data_2:
    #             if abs(current_data[key] - last_data_1[key]) >= 1 or abs(current_data[key] - last_data_2[key]) >= 1:
...
def start_checking_for_changes(client, topic_pub, params):
    with open('./data/dataSub.txt', 'r') as file:
